...
int main(int argc,char *argv[])
{
    ...
    initEntList();
    addEntity(vector4d(0, 1, 1, 1), vector4d(0, 0, 45, 1), vector4d(1, 1, 1, 1), vector4d(0, 1, 0, 1),vector3d(0.01,-0.01,0), 1);
    addEntity(vector4d(-1, 1, 1, 1), vector4d(90, 0, 90, 1), vector4d(1, 0.5, 1, 1), vector4d(0, 0, 1, 1), vector3d(0, -0.01, 0.01), 0);
