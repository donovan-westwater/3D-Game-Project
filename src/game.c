...
int main(int argc,char *argv[])
{
    ...
    initEntList();
    addEntity(vector4d(0, 1, 1, 1), vector4d(0, 0, 0, 1), vector4d(1, 1, 1, 1), vector4d(0, 1, 0, 1),vector3d(-0.01, 0 , 0), 0);
    addEntity(vector4d(-1, 1, 1, 1), vector4d(45, 0, 90, 1), vector4d(1, 2, 1, 1), vector4d(0, 0, 1, 1), vector3d(0.01, 0, 0), 1);
